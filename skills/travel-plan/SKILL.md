---
name: travel-plan
description: 協助自由行旅客快速掌握目的地國家最新、正確、好玩的景點與美食資訊，並整理出國自助旅行的完整行前準備。核心產出是一份可重組的景點/美食素材庫（含彼此的距離關係，避免把實際上很遠的地方誤排在一起），行程安排只是示範用法的參考草案——使用者可以直接採用、自己重組，或拿去跟 agent 進一步討論深化，不是最終定案。觸發情境包含：旅遊規劃、旅行規劃、行程安排、行程規劃、出國準備、自助旅行、自由行、trip planning、travel plan、itinerary、travel itinerary、trip itinerary、plan a trip、旅遊行程、景點推薦、美食推薦、機票住宿整理、簽證通關準備、旅遊保險比較、國外網路方案、當地交通與支付、免稅退稅、當地習慣禁忌、緊急應變準備、行前打包清單、多天行程規劃、家庭/親子/長輩旅遊規劃。當使用者提到要去某個國家/城市旅遊、想知道當地有什麼好玩好吃的、要排幾天幾夜的行程、要準備出國相關事項（簽證、保險、網路、交通、退稅、打包）、或提供了機票/訂房草稿要整理成完整行程時，載入本 skill。
---
